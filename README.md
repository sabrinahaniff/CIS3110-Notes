...
**Note:** These notes are formatted for [Obsidian](https://obsidian.md/). Download this repository and open it in Obsidian for the best experience with working links and tags.
...
1. [Introduction to Operating Systems](01-introduction.md)
2. [Processes and Process Management](02-processes.md)
3. [CPU Scheduling](03-cpu-scheduling.md)
4. [Process Synchronization](04-synchronization.md)
5. [Deadlock](05-deadlock.md)
...
See [Quick Reference Guide](Quick-Reference-Guide.md) for formulas and key concepts.
